...
extern uint8_t USBH_MouseBridge_ReadReport( MouseReport_t *report );
extern uint8_t USBH_MouseBridge_IsConfigured( void );
extern uint32_t USBH_MouseBridge_ReportCount( void );
