...
extern volatile uint8_t  USBFSH_LastPid;
extern volatile uint8_t  USBFSH_LastTog;
extern volatile uint8_t  USBFSH_LastRet;
extern volatile uint8_t  USBFSH_LastIntFg;
extern volatile uint8_t  USBFSH_LastIntSt;
extern volatile uint8_t  USBFSH_LastMisSt;
extern volatile uint8_t  USBFSH_LastHostCtrl;
extern volatile uint16_t USBFSH_LastHostSetup;
extern volatile uint16_t USBFSH_LastRxLen;
extern volatile uint16_t USBFSH_LastWaitLeft;
